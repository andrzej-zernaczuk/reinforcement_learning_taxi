"""Trainer for PPO agent with stable-baselines3."""
...
class PPOTrainer:
    """Trainer for PPO agent using stable-baselines3.
    ...
    def __init__(
        ...
        env,
        agent: PPOAgent,
        log_dir: str | Path = "results/logs/ppo",
    ...
    def train(self, total_timesteps: int) -> dict:
        ...
        if getattr(self.agent, "use_action_masking", False):
            try:
                from sb3_contrib.common.maskable.callbacks import MaskableEvalCallback
            except ImportError as exc:  # pragma: no cover - optional dependency
                raise ImportError(
                    "Maskable PPO evaluation requires sb3-contrib. "
